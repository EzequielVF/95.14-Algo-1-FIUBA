...
int calcula_intensidad(int maldades, int mascotas){
  	...
  	else if((maldades>=CINCO_PUNTOS_INTENSIDAD_DEFENSIVO_MIN && maldades<=CINCO_PUNTOS_INTENSIDAD_DEFENSIVO_MAX)||(maldades>=CINCO_PUNTOS_INTENSIDAD_OFENSIVO_MIN && maldades<=CINCO_PUNTOS_INTENSIDAD_OFENSIVO_MAX)){
    	puntos=CINCO_PUNTOS+mascotas;
  	}
  	return puntos;
}
/*
 * Post: devuelve el bando del juagdor 1 y su intensidad. 
 */
